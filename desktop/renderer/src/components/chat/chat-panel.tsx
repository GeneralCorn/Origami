...
import { API_URL, authHeaders } from "@/lib/api/config";
...
// Streams straight from the FastAPI sidecar. The Next.js proxy route
// this used to call does not exist in the desktop build.
