...
- Resolve tags → doc_ids
- “Chat with tag(s)” start flow
...
Retrieval rule:
allowed_doc_ids = scope_docs ∪ working_set_docs

### 9. Inline @ Mention
- Search docs by title/tags
- Attach to working set
- If outside scope → mark “Imported”

---

## Phase 5 — Hybrid Retrieval and Memory
